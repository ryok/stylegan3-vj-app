...
pretrained_model_url = 'https://api.ngc.nvidia.com/v2/models/nvidia/research/stylegan3/versions/1/files/stylegan3-r-afhqv2-512x512.pkl'
model_path = 'stylegan3-r-afhqv2-512x512.pkl'

def setup():
    if not os.path.exists(model_path):
        # os.system(f"wget {pretrained_model_url} -o {model_path}")
...
def gen_images():
    ...
    with open("./stylegan3vj/style.yaml") as file:
